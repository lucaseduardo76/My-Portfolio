        ...
        <C.Container id='about' ref={secaoRef}>
            <C.Box >
                ...
                <C.textSide className='about-me'>
                    ...
                    <C.Text>
                        Há um ano venho me dedicando a essa área do desenvolvimento full-stack e tenho habilidades em tecnologias como PHP, MySql, JavaScript, React JS, TypeScript, Tailwind e CSS, entre outras.
